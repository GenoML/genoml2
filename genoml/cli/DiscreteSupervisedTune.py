...
def dstune(run_prefix, max_iter, cv_count):
    # TUNING
    # Create a dialogue with the user 
    print("Here is some basic info on the command you are about to run.")
    print("CLI argument info...")
    print("Working with the dataset and best model corresponding to prefix", run_prefix, "the timestamp from the merge is the prefix in most cases.")
    print("Your maximum number of tuning iterations is", max_iter, "and if you are concerned about runtime, make this number smaller.")
    print("You are running", cv_count, "rounds of cross-validation, and again... if you are concerned about runtime, make this number smaller.")
